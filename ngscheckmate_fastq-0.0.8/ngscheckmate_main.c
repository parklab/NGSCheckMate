...
int main(int argc, char* argv[])
{
   ...
   char *patternfilename, fastqfilename[FILENAMEMAX], fastqfilename2[FILENAMEMAX], decoyfilename[FILENAMEMAX];
   int patternlength;
   ...
   static struct option long_options[]= {
      ...
      {"bait", required_argument, 0, 'b' }, /* decoy pattern file */
   ...
   strcpy(decoyfilename,"");
   nodeptherror=0;

   /* parsing options */
   while(1){
       option_index=0;
       c= getopt_long (argc, argv, "1:2:b:s:d:R:L:p:j", long_options, &option_index);
   ...
   h = read_patternfile_construct_hash (patternfilename,decoyfilename);
